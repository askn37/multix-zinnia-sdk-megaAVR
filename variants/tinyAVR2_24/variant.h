...
// #define PIN_TCD0_WOA      PIN_PC0
// #define PIN_TCD0_WOB      PIN_PC4
...
#define PIN_LUT2_IN0      PIN_PB0
#define PIN_LUT2_IN1      PIN_PB1
#define PIN_LUT2_IN2      PIN_PB2
#define PIN_LUT2_OUT      PIN_PB3
#define PIN_LUT2_OUT_ALT1 PIN_PB6
#define PIN_LUT3_IN0      PIN_PC0
#define PIN_LUT3_IN1      PIN_PC1
#define PIN_LUT3_IN2      PIN_PC2
#define PIN_LUT3_OUT      PIN_PC4
#define PIN_LUT3_OUT_ALT1 PIN_PA5

#define PIN_SPI0_MOSI        PIN_PA1
#define PIN_SPI0_MISO        PIN_PA2
#define PIN_SPI0_SCK         PIN_PA3
#define PIN_SPI0_SS          PIN_PA4
#define PIN_SPI0_MOSI_ALT1   PIN_PC2
...
#define PIN_USART1_TXD       PIN_PA1
#define PIN_USART1_RXD       PIN_PA2
#define PIN_USART1_XCK       PIN_PA3
#define PIN_USART1_XDIR      PIN_PA4
#define PIN_USART1_TXD_ALT1  PIN_PC2
#define PIN_USART1_RXD_ALT1  PIN_PC1
#define PIN_USART1_XCK_ALT1  PIN_PC0
#define PIN_USART1_XDIR_ALT1 PIN_PC3
