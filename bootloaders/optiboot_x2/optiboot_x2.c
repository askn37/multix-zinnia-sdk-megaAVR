/**********************************************************/
/* Optiboot bootloader for megaAVR/0 and tinyAVR0/1/2     */
/*                                                        */
...
/*
  The mega-0, tiny-0, tiny-1 and tiny-2 chips all reset to running on the
...
int main (void) {
...
#endif
  {
    ...
    GPIO_GPIOR0 = ch;        // but, stash the reset cause in GPIOR0 for use by app...
