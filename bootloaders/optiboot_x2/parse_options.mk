...
# AVR Dx/megaAVR/tinyAVR HARDWARE RS485 support

HELPTEXT += "Option RS485=1               - Pin for optional rs485 tx enable\n"
ifdef RS485
ifneq ($(RS485), 0)
RS485_CMD = -DRS485=1
dummy = FORCE
...
HELPTEXT += "Option RS485_INVERT=1        - Pin for optional rs485 xdir invert\n"
ifdef RS485_INVERT
ifneq ($(RS485_INVERT), 0)
RS485_INVERT_CMD = -DRS485_INVERT=1
endif
endif

# AVR Dx/megaAVR/tinyAVR HARDWARE SYNCHRONOUS support

HELPTEXT += "Option USART=1                - Pin for optional synchronous enable\n"
ifdef USART
ifneq ($(USART), 0)
USART_CMD = -DUSART=1
BAUD_RATE_CMD = -DBAUD_RATE=USART
BAUD_RATE = USART
dummy = FORCE
endif
endif

HELPTEXT += "Option USART_INVERT=1         - Pin for optional synchronous xck invert\n"
ifdef USART_INVERT
ifneq ($(USART_INVERT), 0)
USART_INVERT_CMD = -DUSART_INVERT=1
endif
endif
...
HELPTEXT += "Option PULLUP_RX=1           - Pin for optional RX pin pullup\n"
ifdef PULLUP_RX
ifneq ($(PULLUP_RX), 0)
PULLUP_RX_CMD = -PULLUP_RX=1
dummy = FORCE
endif
endif
...
UART_OPTIONS = $(UART_CMD) $(BAUD_RATE_CMD) $(RS485_CMD) $(RS485_INVERT_CMD) $(USART_CMD) $(USART_INVERT_CMD) $(PULLUP_RX_CMD)
